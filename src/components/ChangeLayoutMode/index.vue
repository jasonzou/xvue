...
const layoutModeOptions = reactive([
  {
    label: '只有顶部导航',
    value: 'onlyTopNav',
  },
...
<template>
  <div>
    <NSelect v-model="layoutMode" @change="chageLayoutMode">
      <NSelect v-for="item in layoutModeOptions" :key="item.value" :value="item.value" :label="item.label" />
    </NSelect>
  </div>
</template>
