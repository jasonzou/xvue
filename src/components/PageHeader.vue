<template>
    <div class="layout-header">
      ...
      >
        <div class="logo" v-if="navMode === 'horizontal'">
          ...
          <h2 v-show="!collapsed" class="title">Hello websiteConfig.title</h2>
        </div>
        <!-- <AsideMenu
          :collapsed="collapsed"
      ...
      <div class="layout-header-right">
        ...
        <div class="layout-header-trigger layout-header-trigger-min">
          <n-dropdown trigger="hover" @select="avatarSelect" :options="avatarOptions">
            <div class="avatar">
              <n-avatar src="@/assets/images/logo.png">
                <template #icon>
                  <UserOutlined />
                </template>
              </n-avatar>
              <n-divider vertical />
              <span>Jason- username </span>
            </div>
          </n-dropdown>
        </div>
        <!--设置-->
  ...
  <script setup lang="ts">
    ...
    import { NIcon, NTooltip, NDivider, NAvatar } from 'naive-ui';
